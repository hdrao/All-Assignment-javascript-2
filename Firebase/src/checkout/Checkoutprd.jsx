...
//         } else {
//             setTimeout(checkUserEmail, 1500);
//         }
//     };
// }, []);
...
const setDataToLocalStorage = () => {
  console.log("Attempting to save to localStorage..."); // Debugging log
  console.log("userEmail:", userEmail); // Debugging log
  console.log("orderData:", orderData); // Debugging log
...
useEffect(() => {
  console.log("useEffect triggered for localStorage"); // Debugging log
  if (userEmail && orderData) {
    setDataToLocalStorage();
  }
}, [userEmail, orderData]);
...
useEffect(() => {
  ...
  checkUserEmail();
    ...
    useEffect(() => {
        calculateSubtotal();
    }, [cart]); // This will run calculateSubtotal whenever the cart changes
                            ...
                            <div className="w-full">
                              ...
                              <ul className="text-sm text-gray-800 space-y-2 mt-2">
                                <li className="flex flex-wrap gap-4">
                                  Category <span className="ml-auto">{item.category}</span>
                                </li>
                                <li className="flex flex-wrap gap-4">
